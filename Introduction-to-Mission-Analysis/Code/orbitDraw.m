...
%| ["path"]                                                               |
%|                                                                        |
%| "setVisual"              -->     Set viewpoint position               |
%| [ [Azimuth , Elevation] ]                                              |
%|                                                                        |
...
Earth = surf(xE,yE,zE);
Esurfce = imread('texture/Earthtexture.jpg');
...
Cloudmap = imread('texture/earthcloudmap.jpg');
Cloudtrans = imread('texture/earthcloudmaptrans.png');
